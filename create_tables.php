...
Schema::create('resorts_travel_categories', function ($table) {
    $table->id();
    $table->string('name');
...
// Create adverts table manually
Schema::create('resorts_travel_adverts', function ($table) {
    $table->id();
...
echo "Resorts & Travel tables created successfully!\n";
